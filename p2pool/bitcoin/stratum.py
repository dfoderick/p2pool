...
class StratumRPCMiningProvider(object):
    ...
    def rpc_configure(self, extensions, extensionParameters):
        ...
        print '>>>Configure Extensions:' + str(extensions)
        print '>>>Configure Params:' + str(extensionParameters)
        if 'version-rolling' in extensions:
            ...
            print '>>>version-rolling.mask:' + miner_mask
            print '>>>version-rolling.min-bit-count:' + str(minbitcount)
    ...
    def rpc_submit(self, worker_name, job_id, extranonce2, ntime, nonce, version_bits = None, *args):
        ...
        if version_bits:
            ...
            print 'mined asicboost share with version_mask {0}'.format(version_bits)
